...
var NioApp = function (jQ, win, doc) {
  ...
  function docReady(stmt) {
    stmt = _typeof(stmt) === (typeof undefined === "undefined" ? "undefined" : _typeof(undefined)) ? jQ : stmt;
  ...
  function winLoad(stmt) {
    stmt = _typeof(stmt) === "object" ? jQ : stmt;
...
NioApp = function (NioApp, $, window, document) {
  ...
  var _navBreak = 992,
      ...
      _splitURL = _currentURL.split("#"); // is exists @v1.0
  ...
  NioApp.Win.width = $(window).width(); // getStatus @v1.0
  ...
  NioApp.getStatus.asMobile = NioApp.Win.width < _mobBreak ? true : false; // Update on Resize
  ...
  NioApp.Util = {}; // ClassInit !Util @v1.0
  ...
  NioApp.components.docReady.push(NioApp.Util.classInit); // PreLoader !Util @v1.0
  ...
  NioApp.components.winLoad.push(NioApp.Util.preLoader); // BackTop !Util @v1.0
  ...
  NioApp.components.docReady.push(NioApp.Util.backTop); // Browser Check !Util @v1.0
  ...
  NioApp.components.winLoad.push(NioApp.Util.browser); // HeaderSticky !Util @v1.0
  ...
  NioApp.components.docReady.push(NioApp.Util.headerSticky); // imageBG !Util @v1.0
  ...
  NioApp.components.docReady.push(NioApp.Util.Ovm); // progressBar @v1.1
  ...
  NioApp.components.docReady.push(NioApp.Util.progressBar); // inputAnimation @v1.0
  ...
  NioApp.components.docReady.push(NioApp.Util.inputAnimate); // Dropdown @v1.0
  ...
  NioApp.components.docReady.push(NioApp.Util.toggler); // accordionActive @v1.0
  ...
  NioApp.components.docReady.push(NioApp.Util.accordionActive); // scrollAnimation !Util @v1.0
  ...
  NioApp.components.winLoad.push(NioApp.Util.scrollAnimation); // Mainmenu/Nav @v1.0
  ...
  NioApp.components.docReady.push(NioApp.MainMenu); // OnePageScroll @v1.0
  ...
  NioApp.components.docReady.push(NioApp.OnePageScroll); //scrollAct @v1.0
  ...
  NioApp.components.docReady.push(NioApp.scrollAct); //// Plugins ////
  /////////////////

  NioApp.Plugins = {}; // Count Down !Plugin @v1.0
  ...
  NioApp.components.docReady.push(NioApp.Plugins.countdown); // Carousel !Plugin @v1.1
  ...
  NioApp.components.docReady.push(NioApp.Plugins.carousel); // Select2 !Plugin @v1.0
  ...
  NioApp.components.docReady.push(NioApp.Plugins.select2); // Validator !Plugin @v1.0
  ...
  NioApp.components.docReady.push(NioApp.Plugins.validform); // Form Validation !Plugin @v1.0
  ...
  NioApp.components.docReady.push(NioApp.Plugins.submitform); // Parallax !Plugin @v1.0
  ...
  NioApp.components.docReady.push(NioApp.Plugins.parallax); // Popup !Plugin @v1.0
  ...
  NioApp.components.docReady.push(NioApp.Plugins.popup); // particlesJS !Plugin @v1.0
    ...
    if ($particles_bg.exists()) {
      $particles_bg.each(function () {
        var $self = $(this),
            ...
            _default_color = $self.data('default-color') ? $self.data('default-color') : '#000',
            _shape_stroke_color = $self.data('shape-stroke-color') ? $self.data('shape-stroke-color') : '#000',
            _line_linked_color = $self.data('line-linked-color') ? $self.data('line-linked-color') : '#000';
